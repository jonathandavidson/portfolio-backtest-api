...
public class OrderTest {
    ...
    @Test
    public void throwInvalidOrderExceptionWhenBuyOrderHasNegativeQuantity() throws InvalidOrderException {
    ...
    @Test
    public void throwInvalidOrderExceptionWhenSellOrderHasPositiveQuantity() throws InvalidOrderException {
        thrown.expect(InvalidOrderException.class);
